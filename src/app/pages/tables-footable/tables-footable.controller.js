(function() {
  ...
  angular
    .module('minotaur')
    .controller('TablesFooTableController', TablesFooTableController);

  /** @ngInject */
  function TablesFooTableController($timeout) {
    var vm = this;
    vm.users = [
    ...
    $timeout(function(){
      angular.element('#searchTextResults').trigger('footable_redraw');
    },1000)
  }
